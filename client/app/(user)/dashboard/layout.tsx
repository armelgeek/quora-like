...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white border-b lg:px-52 xl:px-52 border-gray-200 shadow-sm relative z-10">
        <div>
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center gap-3 px-2 space-x-4 py-1">
      ...
      <div className="flex mt-10  lg:px-52 xl:px-52">
        <aside className="w-64 bg-white rounded-lg shadow-sm border border-gray-100 fixed lg:static lg:translate-x-0">
